...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'new-artist', loadChildren: () => import('src/app/ventanas/backoffice/nuevo-artista/nuevo-artista.module').then(m => m.NuevoArtistaModule)/* , canActivate: [AuthGuard] */ },
      ...
      { path: 'backoffice/photo_types', loadChildren: () => import('src/app/ventanas/backoffice/photo_types/photo_types.module').then(m => m.PhotoTypesModule)/* , canActivate: [AuthGuard] */ },
      { path: 'backoffice/product_types', loadChildren: () => import('src/app/ventanas/backoffice/product_types/product_types.module').then(m => m.ProductTypesModule)/* , canActivate: [AuthGuard] */ },
      { path: 'backoffice/profiles', loadChildren: () => import('src/app/ventanas/backoffice/nuevo-artista/nuevo-artista.module').then(m => m.NuevoArtistaModule)/* , canActivate: [AuthGuard] */ },
      { path: 'backoffice/release_types',  loadChildren: () => import('src/app/ventanas/backoffice/release_types/release_types.module').then(m => m.ReleaseTypesModule)/* , canActivate: [AuthGuard]*/}, 
      { path: 'backoffice/roles',  loadChildren: () => import('src/app/ventanas/backoffice/rol/rol.module').then(m => m.RolModule)/* , canActivate: [AuthGuard]*/}, 
      { path: 'backoffice/sizes', loadChildren: () => import('src/app/ventanas/backoffice/sizes/sizes.module').then(m => m.SizesModule), /* canActivate: [AuthGuard] */},
    ]
  },
